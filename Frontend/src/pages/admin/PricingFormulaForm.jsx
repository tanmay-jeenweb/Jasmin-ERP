      ...
      <main className="flex-1 w-full mx-auto px-6 py-8">
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {/* Section 3: Brand Wise Overrides */}
                  ...
                  {brandConfigs.map((cfg, configIdx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Override formulas for formulation columns */}
                        <div>
            ...
            <div className="pt-6 border-t border-slate-200 flex items-center justify-end gap-3">
              <button
                type="button"
                onClick={() => navigate("/admin/pricing-formulas")}
                className="px-5 py-2.5 border border-slate-300 rounded-lg text-slate-700 hover:bg-slate-50 font-medium text-sm transition-colors cursor-pointer"
              >
                Cancel
              </button>
              <button
                type="submit"
                disabled={saving}
                className="px-6 py-2.5 bg-gradient-to-r from-indigo-650 to-indigo-750 text-white rounded-lg font-bold text-sm shadow-sm hover:opacity-95 disabled:opacity-50 transition-opacity cursor-pointer"
              >
