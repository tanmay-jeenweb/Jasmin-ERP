...
export default function PricingFormulaMasterList() {
  ...
  const columns = useMemo(() => {
    ...
    const canUpdate = hasPermission("pricing_formula_master", "update") || hasPermission("variation_master", "update");
    const canDelete = hasPermission("pricing_formula_master", "delete") || hasPermission("variation_master", "delete");
  ...
  const canWrite = hasPermission("pricing_formula_master", "write") || hasPermission("variation_master", "write");
  ...
  return (
    <div className="flex flex-col flex-1 bg-slate-50 font-sans">
      ...
      <main className="flex-1 flex flex-col w-full mx-auto px-[30px] py-8">
        ...
        <DataTable
          tableId="pricing_formula_master"
