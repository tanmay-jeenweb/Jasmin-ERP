            ...
            <div className="absolute right-0 mt-1.5 w-[750px] max-w-[90vw] rounded-xl border border-slate-200 bg-white shadow-2xl p-4 z-50 flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col md:border-r md:border-slate-100 pr-2">
                  ...
                  {/* Bulk Actions */}
                  <div className="flex justify-between items-center text-[10px] font-bold text-[#6804a1] mb-2 px-1">
                    <button
                      type="button"
                  ...
                  <div className="max-h-48 overflow-y-auto px-1 py-1 space-y-0.5 border border-slate-100 rounded-lg">
                    {uniqueBranches
                      ...
                      .map(branch => {
                        ...
                        return (
                          <label key={branch.id} className="flex items-center gap-2 px-2 py-1 text-xs text-slate-700 hover:bg-slate-50 rounded cursor-pointer select-none">
                            <input
                              type="checkbox"
                              checked={isChecked}
                              onChange={() => {
